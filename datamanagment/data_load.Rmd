...
rawdata <- read_csv("student_survey_12262016.csv", skip=1) #reads student survey


parent <- read_csv("parent_survey_12262016.csv", skip=1) #reads parent survey


teacher <- read_csv("teacher_survey_12262016.csv", skip=1) # reads teacher survey


q1_dm <- read_csv("q1_data_12262016.csv", skip = 1) #read  q1_dmcsv file
