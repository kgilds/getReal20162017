...
setwd("C:/Users/kevin/Dropbox/GetReal/Data/2016-2017/April 2017")

rawdata <- read_csv("student_data_03312017.csv", skip=1) #reads student survey


parent <- read_csv("parent_03312017.csv", skip=1) #reads parent survey


teacher <- read_csv("teacher_03312017.csv", skip=1) # reads teacher survey


q1_dm <- read_csv("q1_03312017.csv", skip = 1) #read  q1_dmcsv file

q2_dm <- read_csv("q2_03312017.csv", skip =1)
