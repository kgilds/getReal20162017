...
q1_16 <- q1_reading %>%
    select(girl_code, reading_course, Grade, reading_avg)%>%  #select matching columns from previous year
    mutate("Year" = "16-17")  #add new column to distinguish years for when we combine 15-16
