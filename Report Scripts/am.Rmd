...
am_bar_pre_c <-ggplot(pre_am, aes(am.avg >=4.8))+ geom_bar() + facet_wrap(~council) + labs(x="Achieving at High Level", title= "Pre: Academic Mastery by Council")
...
```{r am_council_parent, fig.width=8}
...
```{r pre_teacher_am_council, fig.width=8}
