...
pre_am_histq <- qplot(pre_am$am.avg, geom="histogram", main= "Pre Survey",ylim=c(0,125), bins=40, xlab="Outcome Scores") + geom_vline(xintercept = 4.8, col="red") 
...
The number of responses to the post teacher survey is . 
