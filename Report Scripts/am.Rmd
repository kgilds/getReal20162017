...
This will be an interesting data point to determine if attitudes toward education changes if other life skill outcomes will improve. Currently 105 students have an outcome score that ranges from 3.8 to cutpoint from achieving the outcome at a high level. The Get REAL! program typically has not been in a positon to increase this outcome. Academic Mastery is a foundation for other life skills and outcomes,  a recommondation will be to emphasize the why of education to increase motivation.
