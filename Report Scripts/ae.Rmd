...
**Question 6: She works on her homework at home without supervision.** N=
...
plot(pre_parent_tbl, type="heat") +ggtitle("Parent Pre Survey Question 6") 
...
**Question 5: She positively participates in class.**  N= 

**Question 6: She completes the homework given to her.** N=
...
Students in the Get REAL! program typically do not come into the program with a high academic engagement scores. This year is no different but it the outcomes scores are not consistent with past year. Typically around 40 percent of students come to the program with solid academic behaviors but this year it was 20 percent. 

Parent and teacher pre surveys support evidence from the student survey. Pre teacher surveys indicate about 60 percent believe the student positively particies in class and a little more than half completes home work given to her. 
