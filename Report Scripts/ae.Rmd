...
```{r "ae_q5_parent", fig.height=5, fig.width=12, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
...
```{r "ae_teacher_plots", fig.width=10, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
