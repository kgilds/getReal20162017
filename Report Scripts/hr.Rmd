...
hr_hist <- ggplot(pre_hr, aes(x=hr.avg)) 
     hr_hist + geom_histogram(fill="blue") + facet_wrap(~council) + labs(x=" All Outcome Scores", title = "Pre: Healthy Relationships") + geom_vline(xintercept = 4.45, col="red") 
...
```{r}
last_year <- ggplot(pre_hr, aes(x=hr.avg)) 
     hr_hist + geom_histogram(fill="blue") + facet_wrap(~grade) + labs(x=" All Outcome Scores", title = "Pre: Healthy Relationships") + geom_vline(xintercept = 4.45, col="red") 
...
pre_teacher_tbl <- likert(pre_teacher_tbl, grouping = pre_teacher$council) #likert table


pre_teacher_g<-summary(pre_teacher_tbl) #likert summary
