...
council_lang_summary <- lang_history %>%
    group_by(Year_Id)

council_lang_summary

council_lang_summary <-summarise(council_lang_summary, Grade_Change =mean(Grade_Change))
...
ggplot(council_lang_summary, aes(y=Grade_Change, x=Year_Id, group=2)) + geom_line() + geom_point()
...
council_lang_summary_c <-summarise(council_lang_summary_c, Grade_Change =mean(Grade_Change))


pander(council_lang_summary_c)

ggplot(council_lang_summary_c, aes(y=Grade_Change, x=Year_Id, colour=council, group=2)) + geom_line()  + geom_point()
