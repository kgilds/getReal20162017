...
# Outcome Table by Council and Membership Year
...
ggplot(year_id_lang_summary, aes(y=Grade_Change, x=Year_Id, group=2)) + geom_line() + geom_point() + labs (title= "Average Grade Change by Year")
...
ggplot(council_lang_summary_c, aes(y=Grade_Change, x=Year_Id, colour=council, group=2))  + geom_point(size=3) + labs(title= "Average Grade Change by Year and Council")   #graphical summary
